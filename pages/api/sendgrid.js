...
sendgrid.setApiKey('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');

async function sendEmail(req, res) {
  try {
    // console.log("REQ.BODY", req.body);
    await sendgrid.send({
      to: "prasadtejprakash172@gmail.com", // Your email where you'll receive emails
      from: "prasadtejprakash172@gmail.com", // your website email address here
